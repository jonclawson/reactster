    ...
    FieldDetail.prototype.render = function () {
        ...
        var fieldType = function (field) {
            switch (field.type.toLowerCase()) {
                ...
                case 'select':
                    return React.createElement(availity_reactstrap_validation_1.AvField, { type: "select", name: "{field.name}", title: "{field.title}", helpMessage: "" }, fieldOptions.map(function (fieldOption) {
                        return React.createElement("option", { value: "{fieldOption.value}" }, field.label);
                    }));
            }
        };
...
//# sourceMappingURL=1.b3a4138892d21f25cacd.hot-update.js.map