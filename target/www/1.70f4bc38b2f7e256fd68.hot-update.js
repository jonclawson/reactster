    ...
    FieldDetail.prototype.render = function () {
        ...
        var fieldType = function (field) {
            switch (field.type.toLowerCase()) {
                ...
                case 'select':
                    return React.createElement(availity_reactstrap_validation_1.AvField, { type: "select", name: field.name, label: field.title, helpMessage: "" }, fieldOptions.map(function (fieldOption) { return (React.createElement("option", { value: fieldOption.value }, field.label)); }));
            }
        };
...
//# sourceMappingURL=1.70f4bc38b2f7e256fd68.hot-update.js.map