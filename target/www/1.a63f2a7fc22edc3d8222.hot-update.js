    ...
    FieldDetail.prototype.render = function () {
        ...
        var fieldType = function (field) {
            switch (field.type.toLowerCase()) {
                ...
                case 'select':
                    return React.createElement(availity_reactstrap_validation_1.AvInput, { type: "select", name: field.name, label: field.title, value: fieldValue, helpMessage: "" }, fieldOptions.map(function (fieldOption) { return (React.createElement("option", { value: fieldOption.value }, fieldOption.label)); }));
                case 'radio':
                    return React.createElement(availity_reactstrap_validation_1.AvRadioGroup, { name: field.name, value: fieldValue, label: field.title, errorMessage: "" }, fieldOptions.map(function (fieldOption) { return (React.createElement(availity_reactstrap_validation_1.AvRadio, { label: fieldOption.label, value: fieldOption.value })); }));
            }
        };
...
//# sourceMappingURL=1.a63f2a7fc22edc3d8222.hot-update.js.map