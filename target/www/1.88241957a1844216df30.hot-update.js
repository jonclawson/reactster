...
var FieldDetail = /** @class */ (function (_super) {
    ...
    FieldDetail.prototype.render = function () {
        ...
        var field = this.props.field || this.props.field;
        return (React.createElement("div", null,
            React.createElement(availity_reactstrap_validation_1.AvGroup, null,
                React.createElement("label", null, field.title),
                React.createElement(availity_reactstrap_validation_1.AvInput, { key: fieldKey, id: field.id, type: field.type.toLowerCase(), className: "form-control", name: field.name, title: field.title, value: fieldValue }))));
    };
    return FieldDetail;
}(React.Component));
...
var mapDispatchToProps = { getEntity: field_reducer_1.getEntity };
...
//# sourceMappingURL=1.88241957a1844216df30.hot-update.js.map