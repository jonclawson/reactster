    ...
    FieldDetail.prototype.render = function () {
        ...
        var fieldType = function (field) {
            switch (field.type.toLowerCase()) {
                ...
                case 'select':
                    return React.createElement(availity_reactstrap_validation_1.AvField, { type: "select", name: field.name, label: field.title, helpMessage: "" }, fieldOptions.map(function (fieldOption) { return (React.createElement("option", { value: fieldOption.value }, fieldOption.label)); }));
                case 'radio':
                    return React.createElement(availity_reactstrap_validation_1.AvRadioGroup, { name: field.name, label: field.title, errorMessage: "" }, field.options.map(function (fieldOption) { return (React.createElement(availity_reactstrap_validation_1.AvRadio, { label: fieldOption.label, value: fieldOption.value })); }));
            }
        };
...
//# sourceMappingURL=1.6c07a275ee5cc8ab64ad.hot-update.js.map