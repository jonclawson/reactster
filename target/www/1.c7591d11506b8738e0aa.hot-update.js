    ...
    FieldDetail.prototype.render = function () {
        ...
        var fieldType = function (field) {
            switch (field.type.toLowerCase()) {
                ...
                case 'radio':
                    return React.createElement(availity_reactstrap_validation_1.AvRadioGroup, { name: field.name, label: field.title, errorMessage: "" }, fieldOptions.map(function (fieldOption) { return (React.createElement(availity_reactstrap_validation_1.AvRadio, { label: fieldOption.label, value: fieldOption.value })); }));
            }
        };
...
//# sourceMappingURL=1.c7591d11506b8738e0aa.hot-update.js.map