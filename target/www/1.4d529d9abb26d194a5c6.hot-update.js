    ...
    FieldDetail.prototype.render = function () {
        ...
        var fieldType = function (field) {
            switch (field.type.toLowerCase()) {
                ...
                case 'select':
                    return React.createElement(availity_reactstrap_validation_1.AvField, { type: "select", name: "{field.name}", label: "{field.title}", helpMessage: "" }, fieldOptions.map(function (fieldOption) {
...
//# sourceMappingURL=1.4d529d9abb26d194a5c6.hot-update.js.map